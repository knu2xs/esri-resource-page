...
the polygons for H3 resolution four. This produces far more, smaller, polygons. Then, when running the timezone overlay, I can use these to avoid memory overruns.