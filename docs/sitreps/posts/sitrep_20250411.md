...
- Tested solution for handling platforms (`(stop_type == '0') & (parent.isnotnull())`) to use Arcade instead of modifying data processing...ultimately decided modfiying data processing makes more sense.
- 
